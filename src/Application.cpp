...
{
    auto vertShaderCode = readFile("res/Shaders/Main.vert.spv");
    auto fragShaderCode = readFile("res/Shaders/Main.frag.spv");
    ...
    // Set at drawing time due to being dynamic
    // VkViewport viewport{};
    // viewport.x = 0.0f;
    // viewport.y = 0.0f;
...
void Application::createTextureImage()
{
    ...
    stbi_uc* pixels = stbi_load("res/Textures/texture.jpg", &texWidth, &texHeight,
...
void Application::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
    ...
    VkClearValue clearColour = {{{0.1f, 0.1f, 0.1f, 1.0f}}};
...
void Application::updateUniformBuffer(uint32_t currentImage)
{
    ...
    Uniforms ubo{};
    ubo.model = glm::rotate(glm::mat4(1.0f), deltaTime * glm::radians(90.0f), glm::vec3(0.0, 0.0, 1.0f));
...
void Application::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width,
        uint32_t height)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
